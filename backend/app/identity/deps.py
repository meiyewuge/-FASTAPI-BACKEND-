"""FastAPI dependencies for the authoritative identity chain.

require_session extracts a Bearer token and resolves it to an AuthContext. There
is NO demo_user / bare-header / token_mock_openid_* fallback: a missing or
malformed Authorization header is 401.
"""
